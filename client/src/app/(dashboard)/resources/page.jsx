    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <div className={styles.titleSection}>
          <h1>🎓 Resource Hub</h1>
          <p>Find study materials, placement preparation guides, and video tutorials. Browse categories or save items to your bookmarks.</p>
        </div>
      ...
      {loading ? (
        ...
        <EmptyState
          icon={<BookOpen size={44} style={{ opacity: 0.5 }} />}
          title="No resources found"
          description="Try adjusting your search criteria or resetting filters to find study materials."
          actionText="Reset Filters"
          onAction={resetFilters}
          secondaryText="View Bookmarks"
          secondaryHref="/resources/bookmarks"
        />
      ) : (
