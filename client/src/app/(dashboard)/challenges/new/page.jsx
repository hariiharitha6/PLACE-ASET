...
export default function NewChallengePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to questions assignment for this challenge
      router.push(`/challenges/${created.id}/questions`);
    } catch (err) {
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          <input 
            ...
            placeholder="e.g. Weekly Aptitude Challenge #1"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          <textarea 
            ...
            placeholder="Provide a brief summary of challenge syllabus or goals..."
            className={styles.searchInput}
            style={{ padding: '10px 12px 10px 12px', minHeight: '80px', resize: 'vertical' }}
          />
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          <textarea 
            ...
            placeholder="Rules on blur warnings, timer auto submits, etc..."
            className={styles.searchInput}
            style={{ padding: '10px 12px 10px 12px', minHeight: '120px', resize: 'vertical' }}
          />
        </div>
